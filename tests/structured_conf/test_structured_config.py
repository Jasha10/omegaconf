...
class TestUnionsOfPrimitiveTypes:
    ...
    def test_union_instantiation(
        ...
        if vk is _utils.ValueKind.VALUE:
            ...
            assert cfg._get_node(key).__dict__["_content"] == expected_val
    ...
    @mark.parametrize(
        ...
        [
            param(
                "WithBadDefaults1",
                "Cannot assign None to Union[int, str]",
                id="assign-none-to-uis",
            ),
            param(
                "WithBadDefaults2",
                "Cannot assign 'abc' of type 'str' to Union[bool, Color]",
                id="assign-str-to-ubc",
            ),
            param(
                "WithBadDefaults3",
                "Cannot assign 'True' of type 'bool' to Union[bytes, float]",
                id="assign-bool-to-uxf",
            ),
            param(
                "WithBadDefaults4",
                "Cannot assign 'Color.RED' of type 'tests.Color' to Optional[Union[bool, float]]",
    ...
    @mark.parametrize(
        ...
        [
            ...
            param("Simple", "ubc", "RED", Color.RED, id="simple-ubc-color_str"),
            param(
                "Simple",
                "ubc",
                "a_string",
            ...
            param("WithDefaults", "uis", 123, 123, id="simple-uis-int"),
            param("WithDefaults", "uis", "123", 123, id="simple-uis-int_string"),
            param("WithDefaults", "uis", "abc", "abc", id="simple-uis-str"),
            param(
                "WithDefaults",
                "uis",
                None,
            ...
            param("WithDefaults", "uis", MISSING, MISSING, id="simple-uis-missing"),
            param(
                "WithDefaults", "uis", "${interp}", "${interp}", id="simple-uis-interp"
            ),
            param("WithDefaults", "ubc1", True, True, id="simple-ubc-bool"),
            param("WithDefaults", "ubc1", Color.RED, Color.RED, id="simple-ubc-color"),
            param("WithDefaults", "ubc1", "RED", Color.RED, id="simple-ubc-color_str"),
            param(
                "WithDefaults",
                "ubc1",
                "a_string",
            ...
            param("WithDefaults", "ubc1", MISSING, MISSING, id="simple-ubc-missing"),
            param(
                "WithDefaults", "ubc1", "${interp}", "${interp}", id="simple-ubc-interp"
            ),
            param("WithDefaults", "ouis", None, None, id="simple-ouis-none"),
            ...
            param(
                "ContainersOfUnions",
                "dsubf",
                {"bool": True, "float": 10.1, "float-str": "10.1"},
                {"bool": True, "float": 10.1, "float-str": 10.1},
                id="dsubf",
            ),
            param(
    ...
    def test_resolve_union_interpolation(self, module: Any):
        class_ = module.UnionsOfPrimitveTypes.InterpolationFromUnion
        cfg = OmegaConf.structured(class_)
    ...
    def test_resolve_union_interpolation_error(self, module: Any):
